...
public interface EmployeeService {
    ...
    */
    public void addEmployee(String employeeName, LocalDate employeeDOB, long contactNumber, String mailId, int experience, double salary, String city, int departmentId, long accountNumber, String branch) throws EmployeeException;
