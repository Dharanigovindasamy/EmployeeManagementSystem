    ...
    */
    ...
    public ResponseEntity<DepartmentDto> displayDepartmentById(@PathVariable("id") int departmentId) {
        ...
        if (null == departmentDto) {
            ...
            throw new NoSuchElementException("Can't display.Department not found" + departmentId);
        }
    ...
    */
    ...
    public ResponseEntity<Void> deleteDepartment(@PathVariable("id") int departmentId) {
        ...
        if (null == departmentDto) {
            ...
            throw new NoSuchElementException("Can't Delete.Department not found" + departmentId);
        }
    ...
    public  ResponseEntity<Set<EmployeeDto>> getEmployeesByDepartmentId(@PathVariable("id") int departmentId) {
        ...
        if(null == employeeDtos) {
            ...
            throw new NoSuchElementException("Can't get employees by department Id.Department not found" + departmentId);
        }
